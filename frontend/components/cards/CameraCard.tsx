  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        <div className={clsx(
          'flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border backdrop-blur-md',
          isOnline ? 'bg-[#22C55E]/10 text-[#22C55E] border-[#22C55E]/20' : 'bg-[#EF4444]/10 text-[#EF4444] border-[#EF4444]/20'
        )}>
          <span className={clsx('w-1.5 h-1.5 rounded-full animate-pulse', isOnline ? 'bg-[#22C55E]' : 'bg-[#EF4444]')} />
          {camera.status}
        </div>
      </div>
